//Use orignal scriplet and combine with code in textbook
package ebookshop;
...
//make sure to include the @webServlet "eshop"
@WebServlet("/eshop")

public class ShoppingServlet extends HttpServlet {
	//Helps create a sERIALVERSION UID and avoid any potential exceptions
...
;
      ...
      if (do_this.equals("checkout"))  {
        ...
        //fix formating on the quotation marks
